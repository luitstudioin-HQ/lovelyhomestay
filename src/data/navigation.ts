...
export function getMegaMenuItems() {
  const megaMenuItems: {
    ...
    },
    {
      ...
      children: [
        { title: 'Stay categories', href: '/stay-categories/santo-domingo' },
        { title: 'Experience categories', href: '/experience-categories/mexico-city' },
        { title: 'Car rental categories', href: '/car-categories/ljubljana' },
        { title: 'Flight categories', href: '/flight-categories/santo-domingo' },
      ],
    },
    {
      title: 'Listing details',
      children: [
        { title: 'Stay details', href: '/stay-listings/best-western-cedars-hotel' },
        { title: 'Experience details', href: '/experience-listings/generate-interactive-markets' },
        { title: 'Car rental details', href: '/car-listings/peugeot-108' },
      ],
    },
    {
      title: 'Search pages',
    ...
    },
    {
      ...
      children: [
        ...
        { title: 'Host profile', href: '/authors/truelock-alric' },

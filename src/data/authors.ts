import avatars1 from '@/images/avatars/Image-1.webp'
import avatars2 from '@/images/avatars/Image-2.webp'
import avatars3 from '@/images/avatars/Image-3.webp'
import avatars4 from '@/images/avatars/Image-4.webp'
import avatars5 from '@/images/avatars/Image-5.webp'
import avatars6 from '@/images/avatars/Image-6.webp'
import avatars7 from '@/images/avatars/Image-7.webp'
import avatars8 from '@/images/avatars/Image-8.webp'
...
export async function getAuthors() {
  return [
    ...
    // The `host` blocks in listings.ts use these two handles, and section-host
    // links "See host profile" at /authors/<handle>. Without them those links
    // 404 — keep displayName in sync with the host blocks.
    {
      id: 11,
      ...
      jobName: 'Manager',
      bgImage:
        'https://images.pexels.com/photos/4064835/pexels-photo-4064835.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500',
      starRating: 4.9,
      location: 'London, UK',
      timeAsHost: {
        months: 4,
    ...
    },
    {
      ...
      avatarUrl: avatars1.src,
      count: 8,
      description: 'Passionate about creating memorable experiences for every guest.',
      jobName: 'Designer',
      bgImage:
        'https://images.pexels.com/photos/5799379/pexels-photo-5799379.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500',
      starRating: 4.8,

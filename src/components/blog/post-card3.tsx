...
const PostCard3: FC<Props> = ({ className, post, linkPost = true, footerLabel = 'Read blog', badgeLabel = 'Products' }) => {
    ...
    >
      ...
      <div className="flex flex-col p-5 pt-0">
        <h2 className="block text-lg font-medium">
          {linkPost && <Link href={'/blog/' + handle} className="absolute inset-0"></Link>}
